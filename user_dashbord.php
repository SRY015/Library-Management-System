<?php 
    ...
    function get_user_issue_book_count(){
        ...
        $query = "select count(*) as user_count from issued_books where student_id = $_SESSION[id]";
        $query_res = mysqli_query($connection, $query);
        $user_issue_book_count = 0;
        while($row = mysqli_fetch_assoc($query_res)){
            $user_issue_book_count = $row['user_count'];
        }
...
<body style="background-color:whitesmoke;">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#"><i class="fa-solid fa-book-open-reader"></i> Library Management System</a>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title">No. of total issued books :</h5>
                        <p class="card-text"><?php echo get_user_issue_book_count() ?></p>
                        <a href="user_issued_books.php" class="btn btn-danger">view Issued Books</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3"></div>

...
$query1 = "select * from category where cat_id = $_GET[cid]";
$query_res1 = mysqli_query($connection, $query1);
$category = "";
while($row = mysqli_fetch_assoc($query_res1)){
    $category = $row['cat_name'];
}

if(isset($_POST['editCategory'])){
    $query = "update category set cat_name='$_POST[category_name]' where cat_id = $_GET[cid]";
                    ...
                    <div class="card-body"> 
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="category_name" value="<?php echo $category ?>"/>
                            </div>
                            <button type="submit" class="btn btn-primary" name="editCategory">Add Category</button>
                        </form>
                    </div>
                </div>
            </div>

...
<body>
    ...
    <div class="container-fluid">
        <h3 class="text-center mb-4 text-primary">Manage Books</h3>
        <div class="row">
                    ...
                    <tbody>
                        <?php
                           // $query = "select books.book_id, books.book_name, books.book_no, books.book_price, authors.author_name from books left join authors on books.author_id = authors.author_id";
                            $query = "select books.book_id, books.book_name, books.book_no, books.book_price, authors.author_name, category.cat_name from books inner join authors on books.author_id = authors.author_id inner join category on books.cat_id = category.cat_id";
                        ...
                        <tr>                                                                                       
                            ...
                            <td>
                            <a href="edit_book.php?bno=<?php echo $row['book_no'] ?>"><button type="button" class="btn btn-secondary"><i class="fa-solid fa-pen-to-square"></i> Edit</button></a>
                            <a href="delete_book.php?bno=<?php echo $row['book_no'] ?>"><button type="button" class="btn btn-danger" name="deleteBook"><i class="fa-solid fa-trash"></i> Delete</button></a>
                            </td>
                        </tr>

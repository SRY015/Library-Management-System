...
<body style="background-color:whitesmoke;">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="../home.php"><i class="fa-solid fa-house"></i> Home <span
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
        <a class="navbar-brand pl-5" href="#">Dashboard</a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
            aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="card" style="border:2px solid tomato;">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title">No. of total user :</h5>
                        <p class="card-text"><?php echo get_user_count() ?></p>
                        <a href="viewUsers.php" class="btn btn-danger">view Users</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card" style="border:2px solid blue;">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title">No. of total books :</h5>
                        <p class="card-text"><?php echo get_book_count() ?></p>
                        <a href="viewBooks.php" class="btn btn-primary">view Books</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card" style="border:2px solid yellow;">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title">Total book's category :</h5>
                        <p class="card-text"><?php echo get_category_count() ?></p>
                        <a href="viewCategory.php" class="btn btn-warning">view Categories</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card" style="border:2px solid green;">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title">No. of total Authors :</h5>
                        <p class="card-text"><?php echo get_author_count() ?></p>
                        <a href="viewAuthor.php" class="btn btn-success">view Authors</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mt-5">
                <div class="card" style="border:2px solid black;">
                    ...
                    <div class="card-body text-center">
                        <h5 class="card-title">No. of Issued Books :</h5>
                        <p class="card-text"><?php echo get_issued_book_count() ?></p>
                        <a href="view_issued_books.php" class="btn btn-dark">view Issued Books</a>
                    </div>
                </div>
            </div>
        </div>

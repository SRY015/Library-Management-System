...
<body style="background-color:whitesmoke;">
    ...
    <br /><br />
    <div class="container">
        <h3 class="text-center mb-4 text-primary">Manage Different Book Categories</h3>
        <div class="row">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="edit_category.php?cid=<?php echo $row['cat_id'] ?>"><button type="button" class="btn btn-secondary"><i class="fa-solid fa-pen-to-square"></i> Edit</button></a>
                            <a href="delete_category.php?cid=<?php echo $row['cat_id'] ?>"><button type="button" class="btn btn-danger" name="deleteBook"><i class="fa-solid fa-trash"></i> Delete</button></a>
                            </td>
                        </tr>

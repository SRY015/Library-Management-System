            ...
            <div class="col-md-6">
                <div class="card mb-5">
                    <div class="card-header text-center text-white" style="background-color:tomato;">
                        <h3><i class="fa-solid fa-book"></i> Add New Book <i class="fa-solid fa-book"></i></h3>
                    </div>
                    <div class="card-body"> 
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="book_author" id="author">
                                    <option value="not selected">--- Select Author ---</option>
                                    <?php
                            ...
                            <button type="submit" class="btn btn-primary" name="addBook" id="btn"><i class="fa-solid fa-plus"></i> Add Book</button>
                        </form>
                    </div>
                </div>
            </div>

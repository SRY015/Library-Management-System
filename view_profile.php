...
<body style="background-color:whitesmoke;">
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="user_dashbord.php"><i class="fa-solid fa-book-open-reader"></i> Library Management System</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="nav-item active">
                <a class="nav-link text-light" href="logout.php"><i class="fa-solid fa-right-from-bracket"></i> LogOut</a>
            </div>
        </div>
    </nav>
    <br />
        ...
        <div class="col-md-4">
            ...
            <form action="register.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea rows="4" cols="40" class="form-control" value=<?php echo $address ?> disabled></textarea>
                </div>
            </form>
        </div>
        <div class="col-md-4"></div>
